...
read_specs_test(Node)->
...

   {
    ...
    "https://github.com/joq62/kube.git"," -pa -pa kube/lib/*/* ",
    "tar -xvf kube/kube-0.1.0.tar.gz -C kube ",
    {application,start,[kube],20000},1,[all_hosts]
    ...
    {ok," -pa -pa kube/lib/*/* "}=rpc:call(Node,db_provider_spec,read,[pa_args,"kube"],5000),
