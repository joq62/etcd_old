...
read_all() ->
    Z=do(qlc:q([X || X <- mnesia:table(?TABLE)])),
    [{R#?RECORD.spec ,R#?RECORD.appl_name ,R#?RECORD.vsn ,R#?RECORD.dir ,R#?RECORD.node_name,R#?RECORD.cookie ,
      R#?RECORD.clone_cmd,R#?RECORD.tar_cmd,R#?RECORD.start_cmd,R#?RECORD.num,R#?RECORD.affinity}||R<-Z].
